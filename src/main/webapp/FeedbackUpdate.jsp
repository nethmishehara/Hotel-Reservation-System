    ...
    <%
      ...
      <div class = "continer">
        <div class = "form-box">
            ...
            <form action ="updateFeedback" method = "post" onsubmit = "return validation()" >
                ...
                <div class="input-box">
                    <input type = "text" name="additionalDetail"  placeholder = "Additional Details" value="<%= additionalDetail %>"required>
                </div>
                <div class = "button">
                
                <button type="submit" class ="submit" onclick="clear()">Update data</button>
                </div>
